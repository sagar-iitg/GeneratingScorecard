...
sys.stdout = open(os.path.join(os.getcwd(),"difference","194161013-differences.txt"),"a")
matchNumbers = ['4170','4165','4155','4150','4188','4183','4190','4178','4173','4158']
for MATCHID in matchNumbers:   
    f1 = open(os.path.join(os.getcwd(),"scorecard-computed","194161013-"+MATCHID+"-scorecard-computed.txt"),"r").readlines()
    f2 = open(os.path.join(os.getcwd(),"scorecard-published","194161013-"+MATCHID+"-scorecard-published.txt"),"r").readlines()
