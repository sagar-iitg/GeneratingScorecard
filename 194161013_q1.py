...
matchNumbers = ['4170','4165','4155','4150','4188','4183','4190','4178','4173','4158','4143']
...
for MATCHID in matchNumbers:
    ...
    f1 = open(os.path.join(os.getcwd(),"Commentary","194161013-"+MATCHID+"-commentary.txt"),"r",encoding='UTF8').readlines()
    str1 = f1[0].replace("\n","")
    str2 = f1[1].replace("\n","")
    lis1 = str1.split(",")
    lis2 = str2.split(",")
    ...
    noOfWicketsDict[currentInnings] = wicketCount
    ###############################
    sys.stdout = open(os.path.join(os.getcwd(),"scorecard-computed","194161013-"+MATCHID+"-scorecard-computed.txt"),"w")
    firstInnings = ''
    secondInnings = ''
